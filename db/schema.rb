...
ActiveRecord::Schema.define(:version => 94) do
  ...
  create_table "practices", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.text     "launch_driver"
    t.text     "steers_person"
  end

  add_index "practices", ["team_id"], :name => "index_practices_on_team_id"
  add_index "practices", ["created_at"], :name => "created_at"
  ...
  create_table "tent_positions", :force => true do |t|
    t.integer  "number"
  ...
  add_index "tent_positions", ["status"], :name => "index_tent_positions_on_status"
  add_index "tent_positions", ["number"], :name => "index_tent_positions_on_number"
  ...
  create_table "tents", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "t_type",     :limit => 50, :default => "main"
  end

  add_index "tents", ["team_id"], :name => "index_tents_on_team_id"
  add_index "tents", ["t_type"], :name => "index_tents_on_t_type"
